...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tool=mRootView.findViewById(R.id.toolbar);

        TextView toolbartitle=mRootView.findViewById(R.id.toolbarTitle);
        toolbartitle.setText("Reading..");
    ...
    private void bindViews() {
        ...
        final TextView seeMore=(TextView)mRootView.findViewById(R.id.moreview);
